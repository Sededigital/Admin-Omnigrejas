...
namespace App\Livewire\System\Geral\Users;
...
class Users extends Component
{
    ...
    protected $rules = [
        ...
        'role' => 'required|in:root,super_admin,admin,pastor,ministro,obreiro,diacono,membro,anonymous',
        'is_active' => 'boolean',
    ];
    ...
    public function getUserStats()
    {
        ...
        $newUsersThisMonth = User::where('id', '!=', Auth::id())
                                ->where('role', '!=', 'root')
    ...
    {
        return view('system.geral.users.geral-users', [
            'users' => $this->getUsers(),
