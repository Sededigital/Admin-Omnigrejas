...
use App\Models\AssinaturaCiclo;
use Livewire\Attributes\Layout;
use Livewire\WithoutUrlPagination;
use App\Models\AssinaturaHistorico;
use App\Models\AssinaturaPagamento;
use Illuminate\Support\Facades\Log;
use App\Models\AssinaturaPagamentoFalha;
...
class Pagamentos extends Component
{
    ...
    protected $rules = [
        ...
        'metodo_pagamento' => 'required|in:cartao,deposito,multicaixa_express,tpa,transferencia,outro',
    ...
    public function openModalCiclo($cicloId = null)
    {
        try {
            if ($cicloId) {
                $ciclo = \App\Models\AssinaturaCiclo::find($cicloId);
                if ($ciclo) {
    ...
    public function saveCiclo()
    {
        ...
        try {
            ...
            if ($this->editingCiclo) {
                ...
                \App\Models\AssinaturaCiclo::create($data);
                $this->dispatch('toast', [
                    'type' => 'success',
    ...
    {
        try {
            $query = \App\Models\AssinaturaCiclo::with(['assinatura.pacote', 'assinatura.igreja']);
    ...
    public function openModalFalha($falhaId = null)
    {
        try {
            if ($falhaId) {
                $falha = \App\Models\AssinaturaPagamentoFalha::find($falhaId);
                if ($falha) {
    ...
    public function saveFalha()
    {
        ...
        try {
            $data = [
                ...
                'igreja_id' => \App\Models\AssinaturaPagamento::find($this->falha_pagamento_id)->igreja_id,
            ...
            if ($this->editingFalha) {
                ...
                \App\Models\AssinaturaPagamentoFalha::create($data);
                $this->dispatch('toast', [
                    'type' => 'success',
    ...
    {
        try {
            $query = \App\Models\AssinaturaPagamentoFalha::with(['pagamento.assinaturaHistorico.pacote', 'pagamento.igreja']);
