<div>
                ...
                <div class="row g-3 align-items-end">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" wire:model.live.debounce.300ms="search" placeholder="Nome, email ou telefone">
                        </div>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row g-2 mt-3">
                    <div class="col-12">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button class="btn btn-outline-dark btn-sm" wire:click="setRoleFilter('membro')">
    ...
    @include('system.geral.users.modals.user-modal')
