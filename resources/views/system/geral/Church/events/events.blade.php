<div>
                ...
                <div class="row g-3 align-items-end">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" wire:model.live.debounce.300ms="search" placeholder="Título, descrição ou local">
                        </div>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row g-2 mt-3">
                    <div class="col-12">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <button class="btn btn-outline-warning btn-sm" wire:click="setStatusFilter('em_andamento')">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="event-avatar bg-primary text-white me-3">
                                ...
                                <td>
                                    <div>{{ $event->data_inicio ? $event->data_inicio->format('d/m/Y') : 'N/A' }}</div>
                                ...
                                <td>
                                    @if($event->capacidade_maxima)
                                        <span class="fw-semibold">{{ $event->capacidade_maxima }}</span>
                    ...
                    <div class="card card-hover h-100">
                        <div class="card-body">
                            ...
                            <div class="mb-2">
                                ...
                                <small class="text-muted">{{ $event->data_inicio ? $event->data_inicio->format('d/m/Y') : 'N/A' }}</small>
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <small class="text-muted">{{ $event->local }}</small>
                            </div>
                            @if($event->capacidade_maxima)
                            <div class="mb-3">
                                <i class="fas fa-users text-muted me-1"></i>
                                <small class="text-muted">{{ $event->capacidade_maxima }} pessoas</small>
                            </div>
                            @endif
                            <div class="d-flex gap-2">
    ...
    <!-- Incluir Modal -->
    @include('system.geral.church.events.modals.event-modal')
