<div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $member->membroPerfil->nome ?? 'N/A' }}</td>
                                <td>{{ $member->ministerio->nome ?? 'N/A' }}</td>
                    ...
                    <div class="card card-hover h-100">
                        <div class="card-body">
                            ...
                            <div class="mb-2">
                                ...
                                <small class="text-muted">{{ $member->membroPerfil->nome ?? 'N/A' }}</small>
                            </div>
                            @if($member->ministerio)
                            <div class="mb-2">
                                <i class="fas fa-church text-muted me-1"></i>
                                <small class="text-muted">{{ $member->ministerio->nome }}</small>
                            </div>
                            @endif
                            <div class="mb-3">
    ...
    <!-- Incluir Modal -->
    @include('system.geral.church.members.modals.member-modal')
