<div>
    <div class="container-fluid p-4">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-md-end mt-3 mt-md-0">
                        <div class="btn-group" role="group">
                            <button class="btn btn-outline-secondary btn-md" onclick="window.location.href='/admin'">
                                <i class="fas fa-cog me-2"></i>Gestão ADMIN
                            </button>
                            <button class="btn btn-primary btn-md" wire:click="openModal">
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-6 col-lg-3">
                <div class="card text-center card-hover border-2 border-dashed metric-card" role="button" wire:click="openModal">
                    <div class="card-body">
            ...
            <div class="card-body">
                <div class="row g-3 align-items-end">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" wire:model.live="search" placeholder="Nome da igreja, NIF, localização...">
                    </div>
                    <div class="col-md-2">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm">
                                        <button class="btn btn-outline-primary" wire:click="editIgreja({{ $igreja->id }})" title="Editar">
                    ...
                    <div class="card card-hover h-100">
                        <div class="card-body">
                            ...
                            <div class="d-flex gap-2">
                                <button class="btn btn-primary btn-sm flex-fill" wire:click="editIgreja({{ $igreja->id }})">
    ...
    @include('system.geral.church.only.modals.church-modal')

    {{-- JavaScript específico para Igreja --}}
