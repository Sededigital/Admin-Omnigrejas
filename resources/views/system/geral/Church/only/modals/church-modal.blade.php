        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-light border-bottom">
                <h5 class="modal-title fw-bold" id="churchModalLabel">
                    ...
                    <span id="modal-title">{{ $isEditing ? 'Editar Igreja' : 'Cadastrar Nova Igreja' }}</span>
                </h5>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="nav-basic" role="tabpanel">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control text-uppercase @error('sigla') is-invalid @enderror"
                                ...
                                <div class="col-12">
                                    <div class="alert alert-light border">
                                        ...
                                        <span class="text-muted">
                                            {{ $isEditing ? 'Editando Igreja' : 'Nova Igreja' }}
                                        </span>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-footer border-top bg-light">
                ...
                <button type="button" class="btn btn-primary" wire:click="saveChurch" wire:loading.attr="disabled">
                    <span wire:loading.remove wire:target="saveChurch">
                        <i class="fas fa-save me-1"></i>{{ $isEditing ? 'Atualizar Igreja' : 'Salvar Igreja' }}
                    </span>
