                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Buscar histórico..." wire:model.live.debounce.300ms="search">
                            </div>
                        </div>
                        <div class="col-md-3">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">{{ $item->pacote->duracao_meses ?? 0 }} meses</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
