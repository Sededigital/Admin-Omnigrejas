    ...
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Buscar assinaturas..." wire:model.live.debounce.300ms="search">
                            </div>
                        </div>
                        <div class="col-md-3">
        ...
        document.addEventListener('livewire:loaded', function() {
            ...
            Livewire.on('refresh-pacotes-select', () => {
              //  console.log('Forçando atualização do select de pacotes');
        ...
        {{-- Estilos melhorados para datalist e campos condicionais --}}
