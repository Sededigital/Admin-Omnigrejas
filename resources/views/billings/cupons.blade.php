                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Buscar cupons..." wire:model.live.debounce.300ms="search">
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <table class="table table-striped mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <small class="text-muted">{{ $cupom->criado_em->format('d/m/Y H:i') }}</small>
                                    </td>
                                    <td>
