                        ...
                        <div class="tab-pane fade" id="ciclos" role="tabpanel" aria-labelledby="ciclos-tab" tabindex="0">
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-search"></i></span>
                                        <input type="text" class="form-control" placeholder="Buscar ciclos..." wire:model.live.debounce.300ms="searchCiclos">
                                    </div>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="tab-pane fade" id="falhas" role="tabpanel" aria-labelledby="falhas-tab" tabindex="0">
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-search"></i></span>
                                        <input type="text" class="form-control" placeholder="Buscar falhas..." wire:model.live.debounce.300ms="searchFalhas">
                                    </div>
                                </div>
                                <div class="col-md-3">
