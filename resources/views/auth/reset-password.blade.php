                              ...
                              <div class="row">
                                  ...
                                  <div class="col-lg-12">
                                    <div class="form-group">
                                       ...
                                       <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" wire:model="email"  aria-describedby="email" placeholder="seu email">
                                 ...
                                 <div class="col-lg-12">
                                  ...
                                  <div class="col-lg-12">
                                    <div class="form-group">
                                       ...
                                       <input type="password" class="form-control  @error('password_confirmacao') is-invalid @enderror" id="password_confirmacao" wire:model="password_confirmacao" aria-describedby="password" placeholder="*****">
