    ...
    <div class="sidebar-body pt-0" style="overflow-y: auto; max-height: calc(100vh - 120px);" wire:ignore.self>
        ...
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/dashboard-church') }}" wire:navigate wire:current="active">
                        <i class="icon">
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link " href="{{ url('churches/shepherds') }}" wire:navigate wire:current='active'>
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon"> P </i>
                                <span class="item-name">Pastores</span>
                            </a>
                        </li>
                        <li class="nav-item">
