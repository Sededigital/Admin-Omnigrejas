                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-4">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="genero" id="genero-outro" value="outro" wire:model="genero">
                                                    <label class="form-check-label" for="genero-outro">
                                                        <i class="fas fa-genderless text-secondary me-1"></i>Outro
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
