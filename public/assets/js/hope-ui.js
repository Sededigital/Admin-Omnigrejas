...
if ('scrollRestoration' in history) {
    history.scrollRestoration = 'manual'; // evita que o browser tente restaurar
  }
...
const scrollSidebarToActive = () => {
    ...
    if (activeLink) {
      sidebarBody.scrollTo({
        top: activeLink.offsetTop - sidebarBody.clientHeight / 2,
        behavior: 'instant' // sem animação -> evita tremor
      });
    }
  };
