      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Meus usuários</h3></div>
              <div class="col-sm-6">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-hover align-middle">
                      <thead class="table-light">
                        <tr>
                          <th class="sortable">Nome<i class="bi bi-arrow-up-down text-muted"></i></th>
                          <th class="sortable">Email <i class="bi bi-arrow-up-down text-muted"></i></th>
                          <th class="sortable">Tempo de criação <i class="bi bi-arrow-up-down text-muted"></i></th>
                      ...
                      <tbody>
                        <tr>
                          <td>Janeth Seixas</td>
                          <td>seixas@gmail.com</td>
                            <td>2025-06-25 18:10:10</td>
                          <td class="text-center">
                            <div class="btn-group btn-group-sm" role="group">
                                <button class="btn btn-sm btn-info" title="Contactar">
                                    <i class="bi-send "></i>
                                  </button>
