              ...
              <div class="col-md-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <h5 class="card-title">Relatório das atividades</h5>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-8">
                        <p class="text-center">
                          <strong>Data atual: 25 Abril, 2025</strong>
                        </p>
                        <div id="sales-chart"></div>
                      </div>
                      <!-- /.col -->
                      <div class="col-md-4">
                        <p class="text-center"><strong>atividades<strong></p>
                        ...
                        <!-- /.progress-group -->
                        <div class="progress-group">
                          <span class="progress-text">Novos Serviços</span>
